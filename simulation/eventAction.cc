...
void EventAction::EndOfEventAction(const G4Event* event) {
    ...
    // fill ntuple
    /*
    G4int PDGCode = event->GetDynamicParticle()->GetPDGcode();
    if (PDGCode == 22) {
    ...
    */
    ...
    /*
    man->FillNtupleIColumn(3, 0, eventID);
    man->FillNtupleDColumn(3, 1, fAbsoEdepHCID);
    man->FillNtupleDColumn(3, 2, fAbsoTrackLengthHCID);
    man->FillNtupleDColumn(3, 3, fGapEdepHCID);
    man->FillNtupleDColumn(3, 4, fGapTrackLengthHCID);
    */
